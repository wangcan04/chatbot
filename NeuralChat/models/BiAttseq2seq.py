...
class ChatbotModel(object):
    def __init__(self, vocab_size, hidden_size, dropout,
        ...
        with tf.variable_scope('encoder') as scope:
            ...
            encoder_cell = tf.nn.rnn_cell.MultiRNNCell([encoder_cell for _ in range(num_layers)],state_is_tuple=True)   
        ...
        with tf.variable_scope('decoder') as scope:
            ...
            decoder_cell = tf.nn.rnn_cell.MultiRNNCell([decoder_cell for _ in range(num_layers)],state_is_tuple=True)
